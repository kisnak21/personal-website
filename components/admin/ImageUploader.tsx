...
export function ImageUploader({ slug, currentImage, onImageUpload, onImageDelete, onAltTextChange, altText }: ImageUploaderProps) {
    ...
    <div className='space-y-3'>
      ...
      {currentImage ? (
        <div className='space-y-3 bg-surface-container-high p-4 rounded border border-outline'>
          <div className='relative rounded overflow-hidden bg-surface-container flex items-center justify-center'>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={currentImage} alt={altText || 'Preview'} className='w-full max-h-64 object-cover' />
            <button
              type='button'
        ...
        >
          ...
          <div className='flex flex-col items-center space-y-2'>
            ...
            <div className='text-sm font-medium text-on-surface'>{isUploading ? 'Uploading...' : 'Click to upload screenshot'}</div>
