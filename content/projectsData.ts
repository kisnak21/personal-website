...
export const getTagClassName = (index: number) => tagPalette[index % tagPalette.length]
...
export const fallbackProjects = [
  {
    ...
    techStack: ['React', 'Vite', 'Tailwind CSS', 'Redux Toolkit', 'Axios', 'MockAPI.io'],
    icon: 'explore',
  ...
  },
  {
    ...
    techStack: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Prisma', 'PostgreSQL', 'Auth.js', 'Groq API'],
    icon: 'auto_stories',
